...
export default function DifficultySelection() {
  ...
  const handleDifficultySelect = async (difficulty: Difficulty) => {
    ...
    // Navigate immediately to game page - audio will be generated in the background
    navigate('/game', {
      state: {
        difficulty: difficulty.toUpperCase() as 'EASY' | 'MEDIUM' | 'HARD',
        isGeneratingAudio: true, // Flag to indicate audio is being generated
      },
    });
  };
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-8 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground font-ui text-lg">
            Choose your challenge level. The song will be generated based on your selection.
          </p>
        </motion.section>
